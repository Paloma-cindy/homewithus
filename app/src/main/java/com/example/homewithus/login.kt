...
class login : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        signUp.setOnClickListener{
            signUp.background = ResourcesCompat.getDrawable(resources, R.drawable.switch_trucks, null)
        ...
        login.setOnClickListener{
            ...
            login.background=ResourcesCompat.getDrawable(resources,R.drawable.switch_trucks,null)
